...
#define AI_GESTURE_CNN_ORIGIN_MODEL_NAME   "sine_calcu"
...
#define AI_GESTURE_CNN_IN_1_SIZE        (1)
#define AI_GESTURE_CNN_IN_1_SIZE_BYTES  (4)
...
#define AI_GESTURE_CNN_OUT_1_CHANNEL     (1)
#define AI_GESTURE_CNN_OUT_1_SIZE        (1)
#define AI_GESTURE_CNN_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_GESTURE_CNN_N_NODES (5)
