/**
  ...
  ******************************************************************************
  */
#ifndef AI_SIN_CALC_H
#define AI_SIN_CALC_H

#include "sin_calc_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_SIN_CALC_MODEL_NAME          "sin_calc"
#define AI_SIN_CALC_ORIGIN_MODEL_NAME   "sine_calcu"

/******************************************************************************/
#define AI_SIN_CALC_ACTIVATIONS_ALIGNMENT   (4)
#define AI_SIN_CALC_INPUTS_IN_ACTIVATIONS   (4)
#define AI_SIN_CALC_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_SIN_CALC_IN_NUM        (1)

AI_DEPRECATED
#define AI_SIN_CALC_IN \
  ai_sin_calc_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_SIN_CALC_IN_SIZE { \
  AI_SIN_CALC_IN_1_SIZE, \
}
#define AI_SIN_CALC_IN_SIZE_BYTES { \
  AI_SIN_CALC_IN_1_SIZE_BYTES, \
}
#define AI_SIN_CALC_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_SIN_CALC_IN_1_CHANNEL     (1)
#define AI_SIN_CALC_IN_1_SIZE        (1)
#define AI_SIN_CALC_IN_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_SIN_CALC_OUT_NUM       (1)

AI_DEPRECATED
#define AI_SIN_CALC_OUT \
  ai_sin_calc_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_SIN_CALC_OUT_SIZE { \
  AI_SIN_CALC_OUT_1_SIZE, \
}
#define AI_SIN_CALC_OUT_SIZE_BYTES { \
  AI_SIN_CALC_OUT_1_SIZE_BYTES, \
}
#define AI_SIN_CALC_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_SIN_CALC_OUT_1_CHANNEL     (1)
#define AI_SIN_CALC_OUT_1_SIZE        (1)
#define AI_SIN_CALC_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_SIN_CALC_N_NODES (5)
 ...
 * @ref ai_sin_calc_create. Both the activations memory buffer 
 ...
 * using @ref ai_sin_calc_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_sin_calc_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_sin_calc_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_SIN_CALC_*
 * defines into file @ref sin_calc.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
