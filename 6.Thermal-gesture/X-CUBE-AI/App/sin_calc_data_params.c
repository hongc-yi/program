...
/**  Activations Section  ****************************************************/
ai_handle g_sin_calc_activations_table[1 + 2] = {
...
/**  Weights Section  ********************************************************/
AI_ALIGNED(32)
const ai_u64 s_sin_calc_weights_array_u64[131] = {
...
ai_handle g_sin_calc_weights_table[1 + 2] = {
  AI_HANDLE_PTR(AI_MAGIC_MARKER),
  AI_HANDLE_PTR(s_sin_calc_weights_array_u64),
  AI_HANDLE_PTR(AI_MAGIC_MARKER),
};
